...
@pytest.mark.parametrize("model_name", ["bigscience/bloom-560m", "gpt2", "decapoda-research/llama-7b-hf"])
...
@pytest.mark.parametrize("model_name", ["t5-small", "bigscience/bloom-560m", "gpt2", "decapoda-research/llama-7b-hf"])
@pytest.mark.parametrize("devices", [("cpu",) * 2, ("cpu",) * 3])
