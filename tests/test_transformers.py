...
@pytest.mark.parametrize("model_name", ["bigscience/bloom-560m", "gpt2", "rinna/japanese-gpt-neox-small"])
...
@pytest.mark.parametrize("model_name", ["t5-small", "bigscience/bloom-560m", "gpt2", "rinna/japanese-gpt-neox-small"])
@pytest.mark.parametrize("devices", [("cpu",) * 2, ("cpu",) * 3])
